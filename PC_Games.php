...
<header>
    ...
    <section class="hero">
        <div class="container">
            <h2>PC Games</h2>
            <p>💻🎮Discover Incredible PC Games and Exclusives at Unbeatable Prices! 🎮💻</p>
        </div>
    </section>
    ...
    <section class="product_listings">
        ...
        <div class="container">
            ...
            $productIdsAndDiscounts = getRandomProductIdsByPlatform(1, 30); // Fetch 10 random product IDs for PC platform
